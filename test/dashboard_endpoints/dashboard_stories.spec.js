        ...
        createTestProject(true, user, (project2) => {
          createTestProject(false, user, (project3) => {
            createTestPriority(project1, (priority) => {
              createTestStory(project1, user, null, priority, null, (story) => {
                createTestStory(project1, user, null, null, null, () => {
                  createTestStory(project2, user, null, null, null, () => {
                    createTestStory(project2, user, null, null, null, () => {
                      createTestStory(project3, user, null, null, null, () => {
                        createTestStory(project3, user, null, null, null, () => {
                          testStory = story;
